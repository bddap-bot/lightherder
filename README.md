...
the switcher — framing, gain and glass are a camera's, and the seed
passes none of them.
...
are twelve of them across twelve nodes, no display to point at one
...
change, and the log line is the same readout: the focused
